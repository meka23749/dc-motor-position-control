###########################################################################
## Makefile generated for component 'dc_motor_pid'. 
## 
## Makefile     : dc_motor_pid.mk
## Generated on : Sat Jun 13 13:59:38 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/dc_motor_pid.exe
...
COMPILER_COMMAND_FILE     = dc_motor_pid_comp.rsp
CMD_FILE                  = dc_motor_pid.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/dc_motor_pid.exe
...
DEFINES_STANDARD = -DMODEL=dc_motor_pid -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/dc_motor_pid_ert_rtw/dc_motor_pid.c

MAIN_SRC = $(START_DIR)/dc_motor_pid_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/dc_motor_pid_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/dc_motor_pid_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/dc_motor_pid_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/dc_motor_pid_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/dc_motor_pid_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
dc_motor_pid.obj : $(START_DIR)/dc_motor_pid_ert_rtw/dc_motor_pid.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/dc_motor_pid_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
